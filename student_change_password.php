...
if (isset($_POST['change'])) { $new=$conn->real_escape_string($_POST['new']); $conn->query("UPDATE students SET password='$new' WHERE email='$email'"); $msg="Password updated."; }
?>
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>Change Password</title><link rel="stylesheet" href="style.css"></head>
<body class="theme ep-inner"><div class="main-box"><a href="student_dashboard.php" class="back-btn">← Back</a><h2>Change Password</h2>
